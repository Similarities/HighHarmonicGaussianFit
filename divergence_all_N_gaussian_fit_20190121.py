...
class GaussianFitHighHarmonicDivergence:
    ...
    def nm_in_px(self, energy_nm):
        ...
        self.px_boarder = int(4.38500909e-01 * energy_nm ** 2 - 1.04443316e+02 * energy_nm + 4.25826559e+03)
    ...
    def prepare_header(self):
        ...
        parameter_info = (
            ['fundamental_nm:', str(self.lambda_fundamental), 'pixel_range:', str(self.pixel_range_y), 'evaluated_spatial:'+ str(self.lineout_x[-1])])
        print(self.lineout_x[-1])
...
Picture1 = GaussianFitHighHarmonicDivergence('rotated_20190121/spectro1__Mon Jan 21 2019_17.41.15_35.tif', 800., 15,
                                             17,
                                             "20190123_16")
Picture1.open_file()
Picture1.background()
