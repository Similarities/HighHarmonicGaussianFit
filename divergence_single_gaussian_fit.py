...
# insert the following ('filepath/picture_name.tif', fundamental frequency (float), ROI_y(px),
# harmonic number (int), "picture name for plot")

Picture1 = FWHM_Gaussian_Fit_Processing('rotated/spectro1__Wed Jan 23 2019_14.51.31_17.tif', 805., 60, 23,
                                        "20190123_17")
Picture1.open_file()
Picture1.background()
